...
filename = filename_dir / f"cupy_stencil_explicit_{nx}_{ny}.csv"
np.savetxt(filename, u_cpu, delimiter=",")

# snapshot_dir = Path(f"snapshots")
# snapshot_dir.mkdir(exist_ok=True)
# for i, (t, u_snapshot) in enumerate(snapshots):
#     filename = snapshot_dir / f"cupy_stencil_explicit_t{t:.3f}.csv"
